    ...
    <div className='py-12 bg-gray-900'>
        <div>
            <div className='text-center'>
              ...
              <p className='mt-2 text-3xl font-extrabold  leading-8 sm:text-4xl tracking-tight text-white'>Learn With the Best</p>
            </div>
        </div>
                ...
                {featuredCourses.map((course:Course)=> (
                   <div key={course.id} className='flex justify-center'>
                    ...
                    overflow-hidden h-full max-w-sm'>
                       <div className=' dark:text-neutral-200 p-4 sm:p-6 flex flex-col items-center flex-grow'> 
                       <p className='text-lg sm:text-xl text-black mt-4 mb-2
                        dark:text-neutral-200'>{course.title}</p>
                       <p className='text-sm text-neutral-600  dark:text-neutral-400 flex-row'>{course.description}</p>
